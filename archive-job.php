			...
			<div id="content">
				...
				<div class="row">
				    ...
				    <div id="main" class="<?php echo ($sf_big_col);?> columns role="main">
					 ...
					 <?php 
                      $kennziffer = get_field('kennziffer');
                        if ($kennziffer){
                        	?>
                        	Kennziffer: <?php echo ($kennziffer);?>
                        	<?php
                        }
                        ?>
					    ...
					    <?php else : ?>
    					    ...
    					    <article id="post-not-found" class="hentry clearfix">
    						    <header class="article-header">
    							    <h1><?php _e("Oops, No matching jobs found!", "bonestheme"); ?></h1>
    					    	</header>
    						    <section class="entry-content">
    							    <p><?php _e("Uh Oh. Something is missing. Try searching with different options", "bonestheme"); ?></p>
        						</section>
    	    					<footer class="article-footer">
