...
extract( shortcode_atts( array(
    ...
    $foundsome = FALSE;
    // if the suer ste specific ids of attachments
	if ($ids)
	{
		$ids = explode( ',' , $ids);
		$args = array( 'post_type' => 'attachment', 'numberposts' => -1, 'post_status' => null, 'post__in' => $ids, 'order'=>'ASC' );
